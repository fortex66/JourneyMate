...
router.put('/communitydetail',upload.array('photos[]',1),authMiddleware,uploadController.updateImage);
router.delete('/communitydetail',authMiddleware,uploadController.deleteImage);
router.post('/communitydetail',upload.array('photos[]',1),authMiddleware,uploadController.newImage);
// 커뮤니티 게시글 작성, 삭제, 수정
