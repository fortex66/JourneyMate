            ...
            <Page>
                        ...
                        <>
                            ...
                            {isModalOpen && (
                                <ModalBackground onClick={handleOutsideClick}>
                                    ...
                                    >
                                        <ModalButton onClick={EditCompanion}>
                                            수정
                                        </ModalButton>
                                        <ModalButton
                                            onClick={() => {
                ...
                <ImageContainer>
                    <img
                        src={`${imgURL}${
                            data &&
                            data.post.post_images[0].imageURL.replace(
                                /\\/g,
                                "/"
                            )
                        }`}
                ...
                <ProfileContainer>
                    ...
                    <JoinButton onClick={() => enterChatRoom()}>
                        채팅방 입장
                    </JoinButton>
                </ProfileContainer>
