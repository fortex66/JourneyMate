                    ...
                    <Upwrap>
                        ...
                        <MyInfoBox>
                            <div style={{ alignItems: "center" }}>
                                ...
                                <ID>
                                    {CommunityData &&
                                        CommunityData.posts.rows[0].userID}
                                </ID>
                            </div>
                        </MyInfoBox>
                        <Count>
                            ...
                            <CommunityW>
                                <CT> 커뮤니티</CT>
                                <CC>
                                    {CommunityData && CommunityData.posts.count}
                                </CC>
                            </CommunityW>
                            <CompanionW>
                                <CPT> 동행인</CPT>
                                ...
                                <CPC>
                                    {companionData && companionData.posts.count}
                                </CPC>
                            </CompanionW>
                            <ScrapW
                                onClick={() => {
            ...
            <MyList selectedColor={selectedColor}>
                <div>
                    <FontAwesomeIcon
                        ...
                        size="2x"
                        color={
                            selectedColor === "faGlobe" ? "#f97800" : "black"
                        }
                        onClick={() => {
                    ...
                    {selectedColor === "faGlobe" &&
                        ...
                        CommunityData.posts.rows.map((post, index) => (
                            <CommunityItem
                                ...
                                onClick={() =>
                                    goDetail(
                                        CommunityData.posts.rows[index].tpostID
                                    )
                                }
                            >
                                <div>
                    ...
                    {selectedColor === "faUserGroup" &&
                        ...
                        companionData.posts.rows.map((post, index) => (
                            <CompanionItem
                                ...
                                onClick={() =>
                                    goDetails(
                                        companionData.posts.rows[index].cpostID
                                    )
                                }
                            >
                                <div>
